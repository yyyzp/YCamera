...
public class GLBrooklynFilter extends GLImageFilter {
    ...
    public GLBrooklynFilter(Context context) {
        this(context,VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public GLBrooklynFilter(Context context,String vertexShader, String fragmentShader) {
    ...
    private void createTexture() {
        mCurveTexture =  OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.brooklyn_curves));
        mMapTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.brooklyn_map));
        mCurveTexture1 =OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.brooklyn_curves1));
