...
public class GLEarlyBirdFilter extends GLImageFilter {
    ...
    public GLEarlyBirdFilter(Context context) {
        this(context,VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public GLEarlyBirdFilter(Context context,String vertexShader, String fragmentShader) {
    ...
    private void createTexture() {
        mCurveTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.earlybird_curves));
        mOverlayTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.earlybird_overlay));
        mVignetteTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.earlybird_vignette));
        mBlowoutTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.earlybird_blowout));
        mMapTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.earlybird_map));
    }
