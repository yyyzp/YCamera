...
public class GLFairyTaleFilter extends GLImageFilter {
    ...
    public GLFairyTaleFilter(Context context) {
        this(context,VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public GLFairyTaleFilter(Context context,String vertexShader, String fragmentShader) {
    ...
    private void createTexture() {
        mFairyTaleTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.fairytale));
    }
