...
public class GLFreudFilter extends GLImageFilter {
    ...
    public GLFreudFilter(Context context) {
        this(context,VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public GLFreudFilter(Context context,String vertexShader, String fragmentShader) {
    ...
    private void createTexture() {
        mRandTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.freud_rand));
    }
