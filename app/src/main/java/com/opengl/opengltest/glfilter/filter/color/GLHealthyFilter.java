...
public class GLHealthyFilter extends GLImageFilter {
    ...
    public GLHealthyFilter(Context context) {
        this(context,VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public GLHealthyFilter(Context context,String vertexShader, String fragmentShader) {
    ...
    private void createTexture() {
        ...
        mMaskTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.freud_rand));
    }
