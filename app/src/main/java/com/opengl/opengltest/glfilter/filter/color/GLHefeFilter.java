...
public class GLHefeFilter extends GLImageFilter {
    ...
    public GLHefeFilter(Context context) {
        this(context,VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public GLHefeFilter(Context context,String vertexShader, String fragmentShader) {
    ...
    private void createTexture() {
        mEdgeBurnTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.hefe_edgeburn));
        mMapTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.hefe_map));
        mGradientMapTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.hefe_gradientmap));
        mSoftLightTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.hefe_softlight));
        mMetalTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.hefe_metal));
    }
