...
public class GLSunsetFilter extends GLImageFilter {
    ...
    public GLSunsetFilter(Context context) {
        this(context,VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public GLSunsetFilter(Context context,String vertexShader, String fragmentShader) {
    ...
    private void createTexture() {
        ...
        mMaskTexture = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.sunset_mask));

        mMaskTexture1 = OpenGLUtils.createTextureFromBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.sunset_mask1));
